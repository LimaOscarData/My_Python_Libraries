...
# ------------------------------------------------------------
# Using two groupby :
# print(df1.groupby(['Company', 'Department']).mean())
#                      Age  Sales
# Company Department
# GOOG    HR          36.0  221.5
#         IT          30.0  150.0
...
# print(df1.groupby(['Company', 'Department'])['Sales'].mean())
# Company  Department
# GOOG     HR            221.5
#          IT            150.0
# MSFT     HR            172.0
...
# print(by_comp)
# <pandas.core.groupby.generic.DataFrameGroupBy object at 0x11877bf70>
